...
export default function PrivacyPolicyScreen() {
  return (
    <Layout title="Privacy Policy">
      <div className="flex flex-col ml-10 p-0 md:ml-20 md:p-32">
        <Link href="/">
          <div className="text-[1.2rem] w-12 hover:bg-black hover:text-white">
            Back
          </div>
        </Link>
        <div className="w-[80%] md:w-[70%]">
          <p className="mt-4 font-['Poppins']">
            Privacy Policy for Victis sports&designer webshop
          </p>
          <h1 className="mt-4 text-[3rem]">Privacy Policy</h1>
          <div className="flex justify-end text-[0.9rem] font-['Poppins']">
        ...
        <div className="w-[80%] md:w-[70%]">
          <h1 className="mt-10 text-[2.5rem] mb-5">
            Interpretation and Definitions
          </h1>
          <h2 className="text-[2rem]">Interpretation</h2>
          <p className="mt-4 font-['Poppins']">
        ...
        <div className="w-[80%] md:w-[70%]">
          <h2 className="mt-10 text-[2rem] mb-5">Definitions</h2>
          <p className="mt-5 font-['Poppins']">
            For the purposes of this Privacy Policy:
          </p>
          <ul className="ml-10 list-disc">
            <li className="mt-2 font-['Poppins']">
            ...
            <li className="mt-2 font-['Poppins']">
              ...
              Victis sports&designer webshop.
            </li>
            <li className="mt-2 font-['Poppins']">
            ...
            <li className="mt-2 font-['Poppins']">
              <span className="font-bold">Country</span> refers to: Croatia
            </li>
            <li className="mt-2 font-['Poppins']">
            ...
            <li className="mt-2 font-['Poppins']">
              <span className="font-bold">Website</span> refers to Victis
              sports&designer webshop, accessible from
              https://www.victis-webshop.com
            </li>
            <li className="mt-2 font-['Poppins']">
        ...
        <div className="w-[80%] md:w-[70%]">
          ...
          <h2 className="text-[2rem]">Types of Data Collected</h2>
          <h2 className="mt-4 text-[1.5rem]">Personal Data</h2>
          ...
          <ul className="ml-10 list-disc">
            <li className="mt-2 font-['Poppins'] font-bold">Email address</li>
            <li className="mt-2 font-['Poppins'] font-bold">
              First name and last name
            </li>
            <li className="mt-2 font-['Poppins'] font-bold">
              Address, State, Province, ZIP/Postal code, City
            </li>
            <li className="mt-2 font-['Poppins'] font-bold">Usage Data</li>
          </ul>

          <h2 className="mt-5 text-[1.5rem]">Usage Data</h2>
          <p className="mt-4 font-['Poppins']">
        ...
        <div className="w-[80%] md:w-[70%]">
          <h2 className="mt-10 text-[2rem] mb-5">Use of Your Personal Data</h2>
        ...
        <div className="w-[80%] md:w-[70%]">
          <h2 className="mt-10 text-[2rem] mb-5">
        ...
        <div className="w-[80%] md:w-[70%]">
          <h2 className="mt-10 text-[2rem] mb-5">Delete Your Personal Data</h2>
        ...
        <div className="w-[80%] md:w-[70%]">
          ...
          <h2 className="mt-5 text-[1.5rem]">Business Transactions</h2>
          <p className="mt-4 font-['Poppins']">
          ...
          <h2 className="mt-5 text-[1.5rem]">Law enforcement</h2>
          <p className="mt-4 font-['Poppins']">
          ...
          <h2 className="mt-5 text-[1.5rem]">Other legal requirements</h2>
          <p className="mt-4 font-['Poppins']">
        ...
        <div className="w-[80%] md:w-[70%]">
          <h1 className="mt-4 text-[3rem]">Children's Privacy</h1>
          <p className="mt-4 font-['Poppins']">
        ...
        <div className="w-[80%] md:w-[70%]">
          <h1 className="mt-4 text-[3rem]">Links to Other Websites</h1>
          <p className="mt-4 font-['Poppins']">
        ...
        <div className="w-[80%] md:w-[70%]">
          <h1 className="mt-4 text-[3rem]">Changes to this Privacy Policy</h1>
          <p className="mt-4 font-['Poppins']">
        ...
        <div className="w-[80%] md:w-[70%]">
          <h1 className="mt-4 text-[3rem]">Contact Us</h1>
          <p className="mt-4 font-['Poppins']">
          ...
          <ul className="ml-10 list-disc">
            <li className="mt-2 font-['Poppins']">
              ...
              <span className="underline">victis.marketing@gmail.com</span>
            </li>
          </ul>
        </div>
      </div>
